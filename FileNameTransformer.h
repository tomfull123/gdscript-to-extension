...
public:
	...
	static std::string getOutputFilePath(const std::string& cppFilePathWithoutExtension, const std::string& cppFileName, const std::string& overridePath)
	{
		if (overridePath.empty()) return cppFilePathWithoutExtension + ".h";
		else
		{
